				...
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" id="addHeaderForm" method="post" 
							action="saveTimeSlotData"
							onsubmit="return validateForm()" modelAttribute="login"
							enctype="multipart/form-data">
							
							<div class="form-group">
								<label for="exampleInputName1">Time Slot </label> <input
									type="text" class="form-control" id="timeSlot" name="timeSlot"
									placeholder="Ex- 10:00 AM - 10:15 AM" />
							</div>
