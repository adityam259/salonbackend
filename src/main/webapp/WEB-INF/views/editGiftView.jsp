...
<%
GiftVoucher objData = (GiftVoucher)request.getAttribute("data");
%>
				...
				<div class="card">
					<div class="card-body">
						...
						<form class="forms-sample" id="addHeaderForm" method="post"
							enctype="multipart/form-data" action="updateGiftData"
							...
							<div class="form-group">
								<label for="exampleInputName1">Title</label> <input type="text"
									class="form-control" id="giftTitle" name="giftTitle"
									value="<%=objData.getGiftTitle()%>"
									placeholder="Title" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="exampleInputName1">Price</label> <input type="text"
									class="form-control" id="giftPrice" name="giftPrice"
									value="<%=objData.getGiftPrice()%>"
									placeholder="Price" />
							</div>
							<div class="form-group">

								<label>Upload Gift Image</label> <input type="file"
									name="giftImage" class="file-upload-default" />

								<div class="input-group col-xs-12">
									<input type="text" class="form-control file-upload-info"
										disabled placeholder="Upload Gift Voucher Image"
										name="giftImage" id="giftImage" /> <span
