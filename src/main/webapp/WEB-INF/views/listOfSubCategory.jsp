...
<div class="container-scroller">
	...
	<div class="container-fluid page-body-wrapper">
		...
		<div class="main-panel">
			...
			<%@ page import="java.util.ArrayList"%>
			<%
			List<SubCategoryMaster> listheader = new ArrayList<>();
			if(request.getAttribute("data")!=null){
				listheader = (List<SubCategoryMaster>) request.getAttribute("data");
			}
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
                    		...
                    		for(SubCategoryMaster uploadHeaderData:listheader){
						...
						<div class="d-flex justify-content-center">
							<ul class="pagination">
								...
								<li class="page-item"><a class="page-link"
									href="<c:url value="/listOfSubCategory?page=0&size=${pageSize}"/>">First</a>
								</li>
								<li class="page-item"><a class="page-link"
									href="<c:url value="/listOfSubCategory?page=${currentPage - 1}&size=${pageSize}"/>">Previous</a>
								</li>
								<% } %>
								...
								<li class="page-item <%= (currentPage == i) ? "active" : "" %>">
									<a class="page-link"
									href="listOfSubCategory?page=<%=i %>&size=<%=pageSize%>"><%= i + 1 %></a>
								</li>
								<% } %>
								<% if(currentPage < totalPages - 1){ %>
								<li class="page-item"><a class="page-link"
									href="<c:url value="/listOfSubCategory?page=${currentPage + 1}&size=${pageSize}"/>">Next</a>
								</li>
								<li class="page-item"><a class="page-link"
									href="<c:url value="/listOfSubCategory?page=${totalPages - 1}&size=${pageSize}"/>">Last</a>
								</li>
								<% } %>
							</ul>
						</div>
