...
<nav class="navbar col-lg-12 col-12 p-lg-0 fixed-top d-flex flex-row">
	<div
		...
		<a class="navbar-brand brand-logo-mini align-self-center d-lg-none"
			href="dashboard"><img src="assets/images/logo-mini.svg"
			alt="logo" /></a>
		...
		<ul class="navbar-nav navbar-nav-right ml-lg-auto">
			...
			<li class="nav-item nav-profile dropdown border-0"><a
				class="nav-link dropdown-toggle" id="profileDropdown" href="#"
				data-toggle="dropdown"> <img class="nav-profile-img mr-2" alt=""
					src="assets/images/faces/face1.png" /> <span class="profile-name"
					id="loggedInUserName1"></span>
			</a>
