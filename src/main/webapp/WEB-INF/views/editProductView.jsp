...
<%
	ProductImages objData = (ProductImages)request.getAttribute("data");
						...
						enctype="multipart/form-data"
							...
							<div class="form-group">
								<label for="exampleInputPassword4">Price</label> <input
									...
									placeholder="25*.**" value="<%=objData.getRate()%>"/>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="file"
									name="productImage" class="file-upload-default" />
									
								<div class="input-group col-xs-12">
									<input type="text" class="form-control file-upload-info"
										disabled placeholder="Upload Banner / Header"
										name="productImage" id="productImage" /> <span
