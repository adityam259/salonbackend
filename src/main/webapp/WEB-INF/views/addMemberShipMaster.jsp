				...
				<div class="card">
					<div class="card-body">
						...
						enctype="multipart/form-data"
							action="addMembershipDetails"
							onsubmit="return validateForm()">
							<div class="form-group">
								<label for="exampleInputName1">Heading</label> <input
									type="text" class="form-control" id="title" name="heading"
									placeholder="Heading" />
							</div>
							<div class="form-group">
								<label for="exampleInputEmail3">Membership Description</label>
								<textarea class="form-control" id="editor" name="description"
									rows="4"></textarea>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail3">Terms & Conditions</label>
								<textarea class="form-control" id="editor2" name="termsConditions"
									rows="4"></textarea>
							</div>
							<div class="form-group">
								<label for="exampleInputName1">Price</label> <input
